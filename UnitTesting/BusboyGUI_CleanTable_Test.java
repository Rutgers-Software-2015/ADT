...
public class BusboyGUI_CleanTable_Test {
	...
	public static void precondition(){
		...
		log.add("Meeting preconditions (setting table as Unclean");
		testComm.update("UPDATE MAINDB.Table_Statuses SET T_Status = 'Unclean' WHERE TABLE_ID = 1;");
		log.add("Success!");
		log.add("");
	}
	
	public static void ChangeTableStatus(){
		log.add("Beginning to set table as clean: ");
		...
		log.add("Changing Table 1 status to clean: ");
