...
public class GradientButton extends JButton implements MouseListener {
     ...
     */
    private static final Color DEFAULT_COLOR_1 = Color.white;
    /**
     * The second color of the Gradient background which acts as Default.
     */
    private static final Color DEFAULT_COLOR_2 = Color.gray.brighter();
    /**
    ...
    /**
     * This method is use to toggle visibility of the JComponent.
     *
     * @param none
     * 
     */
